...
export class TimesSoldComponent implements OnInit, OnDestroy {
  ...
  onSubmit(settingsForm: { showNoOrders: string | null; }) {
   ...
   * @param imgUrl 
   */
  onHovering(eventObject: { target: { children: { [x: string]: { children: { [x: string]: any; }; }; }; }; }, imgUrl: any) {
   ...
   * @param eventObject 
   */
  onUnhovering(eventObject: { target: { children: { [x: string]: { children: { [x: string]: any; }; }; }; }; }) {
