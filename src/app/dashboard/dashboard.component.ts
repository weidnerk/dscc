...
export class DashboardComponent implements OnInit {
  ...
  onStoreSelected(event: MatSelectChange) {
    ...
    this.unfulfilledOrders = null;
    this.storeAnalysis = null;
    const selectedData = {
  ...
  onCompareOrders() {
    ...
    this._orderHistoryService.compareOrders(this.selectedStore, fromDate, toDate)
    .subscribe(unfulfilledOrders => {
